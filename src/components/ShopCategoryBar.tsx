        ...
        <div className="w-full bg-white border-b border-gray-100 transition-all duration-300">
            <div className="max-w-[1920px] mx-auto relative group">
                ...
                >
                    <button
                        onClick={() => scroll("left")}
                        className="bg-white/90 backdrop-blur-sm rounded-full p-1 shadow-md border border-gray-100 hover:bg-gray-50 transition-colors pointer-events-auto hidden md:block focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400"
                ...
                <div
                    ...
                    className="w-full overflow-x-auto no-scrollbar scroll-smooth snap-x snap-mandatory py-4"
                    role="tablist"
                    aria-label="Product Categories"
                >
                    <div className="w-fit mx-auto flex gap-3 md:gap-4 items-center px-4 md:px-12">
                        <button
                            ...
                            className={cn(
                                "relative shrink-0 px-5 py-2 rounded-full text-xs font-bold uppercase tracking-widest transition-all duration-300 border snap-center focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400",
                                activeCategory === "All"
                                    ? "bg-gray-900 text-white border-gray-900 shadow-md transform scale-105"
                                    : "bg-white text-gray-500 border-gray-200 hover:border-gray-900 hover:text-gray-900 hover:scale-105"
                            )}
                        >
                            View All
                        </button>
